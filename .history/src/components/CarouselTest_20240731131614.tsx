  ...
  return (
    <div className="pb-[100px] text-white h-screen">
      <div className="relative">
        ...
        <div className="absolute top-0 w-full h-full border-2 border-blue-gray-600 flex place-items-center bg-white bg-opacity-5 ">
          <div className="navs absolute bottom-[100px] left-[55%] translate-x-1/2 flex gap-5">
            <button
              onClick={previous}
              type="button"
              className="bg-white opacity-50 px-3"
            >
              <i className="fa-solid fa-chevron-left"></i>
            </button>
            <button onClick={next} type="button" className="bg-white opacity-50 px-3">
