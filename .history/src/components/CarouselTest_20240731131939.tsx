        ...
        <div className="absolute top-0 w-full h-full border-2 border-blue-gray-600 flex place-items-center text-main-color bg-white bg-opacity-5 ">
          <div className="navs absolute bottom-[100px] left-[55%] translate-x-1/4 flex gap-5">
            <button
              onClick={previous}
              type="button"
              className="text-main-color bg-white bg-opacity-40 rounded-full w-[40px] h-[40px] flex items-center justify-center"
            >
              <i className="fa-solid fa-arrow-left"></i>
            </button>
            <button onClick={next} type="button" className="text-main-color bg-white bg-opacity-40 rounded-full w-[40px] h-[40px] flex items-center justify-center">
