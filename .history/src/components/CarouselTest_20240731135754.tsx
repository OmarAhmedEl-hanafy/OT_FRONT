              ...
              >
                <div className="">
                  <div className="h-[300px] max-w-[488px] m-auto translate-x-[50%]">
                    <img className="w-full shadow-2xl h-full" src={img1} alt="" />
                  </div>
                </div>
                <div className="">
                  <div className="h-[300px] max-w-[488px] m-auto translate-x-[50%]">
                    <img className="w-full shadow-2xl h-full" src={img2} alt="" />
                  </div>
                </div>
                <div className="">
                  <div className="h-[300px] max-w-[488px] m-auto translate-x-[50%]">
                    <img className="w-full shadow-2xl h-full" src={img3} alt="" />
                  </div>
                </div>
                <div className="">
                  <div className="h-[300px] max-w-[488px] m-auto translate-x-[50%]">
                    <img className="w-full shadow-2xl h-full" src={img4} alt="" />
                  </div>
                </div>
                <div className="">
                  <div className="h-[300px] max-w-[488px] m-auto translate-x-[50%]">
                    <img className="w-full shadow-2xl h-full" src={img5} alt="" />
                  </div>
                </div>
              </Slider>
            </div>
