      ...
      <div className="relative">
        <div className="">
          <Slider
            ...
            {...settings1}
            className="border-2 border-blue-gray-600 flex items-center  "
          >
            <div className="h-[450px] relative border-2 border-blue-gray-600  mt-[50px]">
              {/* <img className="w-full h-full" src={img1} alt="" /> */}
              <div className="desc border-2 border-blue-gray-600 absolute w-1/2 left-[50px] flex flex-col justify-center">
            ...
            <div className="h-[450px] relative">
              ...
              <div className="desc border-2 border-blue-gray-600 absolute w-1/2 left-[50px] z-40">
                <h2 className="text-main-color text-2xl font-bold">
