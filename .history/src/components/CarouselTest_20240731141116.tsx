        ...
        <div className="">
          ...
          >
            <div className="h-[450px] relative border-2 border-blue-gray-600 ">
              ...
              <div className="desc mt-[50px] border-2 border-green-600 absolute w-1/2 left-[50px] flex flex-col justify-center">
            ...
            <div className="h-[450px] relative">
              ...
              <div className="desc mt-[50px] border-2 border-blue-gray-600 absolute w-1/2 left-[50px] z-40">
                <h2 className="text-main-color text-2xl font-bold">
