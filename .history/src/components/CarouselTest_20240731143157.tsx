...
function Carousel() {
  ...
  return (
    <div className="pb-[100px] text-white h-screen">
      <div className="relative">
        <div className="">
          <Slider
            ...
            {...settings1}
            className="border-2 border-red-600 flex items-center  "
          >
            <div className="h-[450px] relative border-2 border-blue-gray-600 ">
              {/* <img className="w-full h-full" src={img1} alt="" /> */}
              <div className="desc mt-[70px] border-2 border-green-600 absolute w-1/2 left-[50px] flex flex-col justify-center">
                <h2 className="text-main-color text-3xl md:w-[50%] uppercase font-bold">
                  Transform your life with personalized coaching.
                </h2>
                <p className="w-[50%] mt-[50px]">
            ...
            <div className="h-[450px] relative">
              ...
              <div className="desc mt-[70px] border-2 border-blue-gray-600 absolute w-1/2 left-[50px] z-40">
                <h2 className="text-main-color text-2xl font-bold">
                  Achieve your goals and live your best life with expert
                  coaching.
                </h2>
                <p className="text-main-color font-bold w-[50%] mt-[50px]">
        ...
        <div className="absolute top-0 w-full h-full flex place-items-center text-main-color bg-white bg-opacity-5 ">
          <div className="navs absolute bottom-[50px] left-[55%] translate-x-1/4 flex gap-5">
            ...
            <button onClick={next} type="button" className="text-main-color bg-white bg-opacity-30 rounded-full w-[40px] h-[40px] flex items-center justify-center">
          ...
          <div className="max-w-max max-h-max ">
            <div className="w-[100vw]">
              ...
              >
                <div className="">
                  <div className="h-[300px] max-w-[488px] m-auto translate-x-[50%]">
                    <img className="w-full h-full" src={img1} alt="" />
                  </div>
                </div>
                <div className="">
