          ...
          >
            <div className="h-[450px] relative ">
              ...
              <div className="desc mt-[70px] absolute w-1/2 left-[50px] flex flex-col justify-center">
                <h2 className="text-main-color text-4xl leading-10 tracking-[3px] md:w-[50%] font-extrabold">
                  Transform your life with personalized coaching.
                </h2>
                <p className="w-[75%] tracking-[2px] text-black/95 mt-5">
              ...
              >
                <div className="">
                  <div className="h-[300px] max-w-[488px] m-auto translate-x-[50%]">
                    <img className="w-full h-full translate-x-1/2" src={img1} alt="" />
                  </div>
                </div>
                <div className="">
                  <div className="h-[300px]  max-w-[488px] m-auto translate-x-[50%]">
                    <img className="w-full h-full translate-x-1/2" src={img2} alt="" />
                  </div>
                </div>
                <div className="">
                  <div className="h-[300px]  max-w-[488px] m-auto translate-x-[50%]">
                    <img className="w-full h-full translate-x-1/2" src={img3} alt="" />
                  </div>
                </div>
                <div className="">
                  <div className="h-[300px]  max-w-[488px] m-auto translate-x-[50%]">
                    <img className="w-full h-full translate-x-1/2" src={img4} alt="" />
                  </div>
                </div>
                <div className="">
                  <div className="h-[300px]  max-w-[488px] m-auto translate-x-[50%]">
                    <img className="w-full h-full translate-x-1/2" src={img5} alt="" />
                  </div>
                </div>
              </Slider>
            </div>
