      ...
      <div className="relative">
          ...
          >
            <div className="h-[450px] relative ">
              ...
              <div className="desc mt-[70px] absolute bottom-0 left-[50px] md:w-1/2 md:bottom-auto flex flex-col justify-center">
                <h2 className="text-main-color text-xl md:text-4xl md:leading-10 tracking-[3px] md:w-[75%] font-extrabold">
        ...
        <div className="absolute top-0 w-full h-full flex place-items-center text-main-color bg-white bg-opacity-5 ">
          <div className="border-2 border-white">
            <div className="navs absolute bottom-[25px] left-[30%] md:bottom-[50px] md:left-[55%] translate-x-1/4 flex gap-5">
              <button
                onClick={previous}
                type="button"
