        ...
        <div className="absolute top-0 w-full h-full flex place-items-center text-main-color bg-white bg-opacity-5 ">
          ...
          <div className="max-w-max max-h-max ">
            <div className="w-[100vw]">
              ...
              >
                <div className="">
                  <div className="h-[300px]  md:max-w-[350px] lg:max-w-[488px] m-auto  md:translate-x-[15%] lg:translate-x-[50%]">
                    <img className="w-full h-full" src={img1} alt="" />
                  </div>
                </div>
                <div className="">
                  <div className="h-[300px]   md:max-w-[350px] lg:max-w-[488px] m-auto md:translate-x-[215] lg:translate-x-[50%]">
                    <img className="w-full h-full" src={img2} alt="" />
                  </div>
                </div>
                <div className="">
