      ...
      <div className="container pt-[70px]">
        <div className="grid md:grid-cols-3 gap-5 items-center">
          ...
          <div className="flex flex-col gap-5">
            <div className="">
              <Link className="text-main-color" to="/">Help Center</Link>
            </div>
            <div className="">
              <Link className="text-main-color" to="/">Privacy Policy</Link>
            </div>
            <div className="">
              <Link className="text-main-color" to="/">FAQ</Link>
            </div>
            <div className="">
              <Link className="text-main-color" to="/">Terms & Condition</Link>
            </div>
            <div className="">
              <Link className="text-main-color" to="/">Community</Link>
            </div>
          </div>
            ...
            <div className="w-full max-w-md px-4">
              <Field>
                ...
                <div className="relative">
                  <Input
                    className={clsx(
                      "mt-3 block w-full rounded-xl border-none bg-white py-4 px-3 text-sm/6 text-main-color",
                      "focus:outline-none data-[focus]:outline-2 data-[focus]:-outline-offset-2 data-[focus]:outline-[#FFC224]"
                    )}
                    placeholder="Email"
                  />
