      ...
      <div className="container pt-[70px]">
        <div className="grid md:grid-cols-3 gap-5 items-center">
          ...
          <div className="flex flex-col gap-5 text-main-color">
            <div className="">
              <Link className="text-main-color hover:text-red-900" to="/">Help Center</Link>
            </div>
            <div className="">
              <Link className="text-main-color hover:text-red-900" to="/">Privacy Policy</Link>
            </div>
            <div className="">
              <Link className="text-main-color hover:text-red-900" to="/">FAQ</Link>
            </div>
            <div className="">
              <Link className="text-main-color hover:text-red-900" to="/">Terms & Condition</Link>
            </div>
            <div className="">
              <Link className="text-main-color hover:text-red-900" to="/">Community</Link>
            </div>
          </div>
