      ...
      <div className="container pt-[70px]">
        <div className="grid md:grid-cols-3 gap-5 items-center">
          ...
          <div className="flex flex-col gap-5 text-main-color">
            <div className="">
              <Link className="text-main-color hover:font-bold hover:underline" to="/">Help Center</Link>
            </div>
            <div className="">
              <Link className="text-main-color hover:font-bold hover:underline" to="/">Privacy Policy</Link>
            </div>
            <div className="">
              <Link className="text-main-color hover:font-bold hover:underline" to="/">FAQ</Link>
            </div>
            <div className="">
              <Link className="text-main-color hover:font-bold hover:underline" to="/">Terms & Condition</Link>
            </div>
            <div className="">
              <Link className="text-main-color hover:font-bold hover:underline" to="/">Community</Link>
            </div>
          </div>
