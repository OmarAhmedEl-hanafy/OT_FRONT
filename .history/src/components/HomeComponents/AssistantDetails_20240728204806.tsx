...
function AssistantDetails({ assistant }: props) {
  ...
  return (
    <div className="grid md:grid-cols-2 items-center mt-5 gap-y-5">
      <div style={{ boxShadow: '8px 8px 0px #9F2929'}} className="relative h-[350px] w-[220px] mx-auto ">
        <img className="ml-7" src={assistant.instructorPhoto} alt={assistant.instractorName} />
      ...
      <div className=" text-center md:text-start">
        ...
        <h2 className="mt-4 mb-2 font-bold text-2xl">{assistant.instractorName}</h2>
