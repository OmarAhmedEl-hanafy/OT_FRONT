...
function AssistantDetails({ assistant }: props) {
  ...
  return (
    <div className="grid md:grid-cols-2 items-center mt-5 gap-5">
      <div
        className=""
      >
        <div style={{ boxShadow: "8px 8px 0px #9F2929" }} className=" box-border rounded-[20px] px-10 w-[60%] h-[350px] mx-auto">
          <img
            className=""
