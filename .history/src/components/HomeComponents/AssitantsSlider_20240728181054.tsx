      ...
      <div className="relative mt-10 py-5 px-[50px] md:px-[70px] mx-3 bg-white border border-[#D0D0D0] rounded-[50px] md:rounded-[100px]">
        ...
        <div className="absolute top-[50%] left-0 right-0 -translate-y-1/2 px-5 flex">
          <button
            ...
            className=" w-[30px] h-[30px] md:w-[40px] md:h-[40px] hover:bg-main-color hover:text-[#ffffff] rounded-full bg-[#FFC224] border"
          >
          ...
          <button
            onClick={previous}
            style={{ boxShadow: "2px 4px 0px #382900" }}
            className="block ml-auto w-[30px] h-[30px] md:w-[40px] md:h-[40px] hover:bg-main-color hover:text-[#ffffff] rounded-full bg-[#FFC224] border"
          >
