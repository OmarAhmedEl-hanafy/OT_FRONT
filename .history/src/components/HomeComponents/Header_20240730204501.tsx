...
function Header() {
  ...
  return (
    <section className="relative mt-[100px] border-2 border-red-500">
      ...
      <div className="absolute top-0 left-0 w-full h-[92vh] -z-10 border-2 border-blue-gray-600 ">
        <img className="border-2 border-red-400" src={bg} />
      </div>
    </section>
  );
}
