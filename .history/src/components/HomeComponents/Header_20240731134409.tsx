...
function Header() {
  ...
  return (
    <section className="relative mt-[100px] h-screen">
      ...
      <div style={{background: 'linear-gradient(180deg, rgba(160, 41, 41, 0) 0%, rgba(160, 41, 41, 0.77) 100%)',}} className="absolute top-0 left-0 w-full h-[85%] -z-10">
...
// box-shadow: 0px 30px 60px rgba(160, 41, 41, 0.2);
