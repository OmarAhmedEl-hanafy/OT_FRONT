  ...
  return (
    <div className="relative h-[500px] flex justify-around">
      <div className="absolute bottom-0 left-0 w-[250px] h-[430px] ">
        ...
        <div className="absolute h-[15px] w-[200px] bottom-0 right-0 translate-x-1/4 -translate-y-5">
          <img src={img7} alt="Career professional side" />
        </div>
      </div>

      <div className="relative w-[200px] h-[230px] bg-main-color ml-[200px] ">
        <div className="absolute w-full h-full top-0 left-0 border-2 border-main-color border-dashed rounded-lg -translate-x-[15px] -translate-y-[15px]"></div>
      </div>
    </div>
  );
}
