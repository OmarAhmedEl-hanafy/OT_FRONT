        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="">
            <div className="relative h-[500px] pr-[100px] overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 w-[250px] h-[250px] flex items-center justify-center -translate-x-1/4 translate-y-1/4 rounded-full bg-[#1a2b4c] border-8 border-white circle-nums">
