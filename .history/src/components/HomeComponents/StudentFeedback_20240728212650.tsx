      ...
      <div className="container">
        ...
        <div className="relative mt-5">
          ...
          <div className="absolute top-[50%] left-0 right-0 -translate-y-1/2 px-5 flex">
            <button
              onClick={next}
              className="md:translate-x-[-150%] transition-all duration-300 w-[30px] h-[30px] md:w-[40px] md:h-[40px] border border-[#C9E4E9]  hover:bg-main-color hover:text-white rounded-full bg-white shadow-lg"
            >
            ...
            <button
              onClick={previous}
              className="md:translate-x-[150%] transition-all duration-300 block ml-auto w-[30px] h-[30px] md:w-[40px] border border-[#C9E4E9]  md:h-[40px] hover:bg-main-color hover:text-white rounded-full bg-white shadow-lg"
            >
