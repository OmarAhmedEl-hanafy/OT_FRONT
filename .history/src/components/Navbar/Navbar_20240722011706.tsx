        ...
        if (ref && "current" in ref && ref.current) {
          ...
          if (window.scrollY < 3890) {
            ...
            childLinks.forEach((link) => {
              (link as HTMLElement).style.color = "rgb(5, 67, 153) !important";
            });
          } else if (window.scrollY > 3890 && window.scrollY < 4250) {
            const childLinks = parentElement.querySelectorAll("navlink");
            childLinks.forEach((link) => {
              (link as HTMLElement).style.color = "#ffffff !important";
            });
          } else {
            const childLinks = parentElement.querySelectorAll("navlink");
            childLinks.forEach((link) => {
      ...
      >
        <div className="container mx-auto flex justify-between items-center">
          ...
          <ul className="hidden lg:flex gap-5 flex-row ">
            <li>
              <NavLink end to="/" className="navlink text-main-color block py-2 px-4">
                Home
              </NavLink>
            </li>
            <li>
            ...
            <li>
              <NavLink to="/blog" className="navlink text-main-color block py-2 px-4">
                Blog
              </NavLink>
            </li>
            <li>
