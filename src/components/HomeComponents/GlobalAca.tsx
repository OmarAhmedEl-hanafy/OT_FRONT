...
import vid from "../../assets/images/video-1.mp4";
...
function GlobalAca() {
  ...
  return (
    <div
      className="relative z-30 pl-5 flex items-center"
    >
      <div className=" grid md:grid-cols-2 text-main-color w-full">
            ...
            <div className="">
              ...
              <ul className="text-xl mt-5">
                ...
                >
                  ...
                  <span>Gain Clarity and Focus</span>
                </motion.li>
                <motion.li
                  variants={h1Variants}
                  initial="hidden"
                ...
                >
                  <i className="fa-solid fa-check-circle"></i>
                  <span>Achieve Your Potential</span>
                </motion.li>
              </ul>
              <motion.div
                variants={h1Variants}
              ...
              >
                <Link
                  data-content={`START`}
                  to={"/"}
                  className="btn btn-main  bg-main-color text-white gap-2 p-5"
                >
        ...
        <motion.div
          ...
          animate={`${isInView ? "visible" : ""}`}
          transition={{ ease: "easeOut", duration: 0.5, delay: 1.8 }}
          className="relative h-[350px] self-end"
        >
          <div className="bg-main-color w-[50%] h-full ml-auto"></div>
          <div className="absolute md:pl-16 overflow-hidden top-0 right-0 w-full h-full border-[15px] bg-main-color border-main-color rounded-full">
            <video
