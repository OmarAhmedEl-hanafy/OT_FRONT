...
//                 Thousand Of Top
//                 <span className="inline-block text-main-color relative ml-2">
...
//             <p className="mt-2">
//               He was among the first educators in Egypt and the Arab world to
//               provide practical, exam-focused training for international school
//               students. His unique teaching method relies on simplified
//               problem-solving strategies and real-life simulations that make
//               complex concepts easier to understand. By engaging both the
//               analytical and emotional sides of learning, he helps students
//               overcome negative beliefs, build strong academic foundations, and
//               achieve outstanding results. Today, he is recognized as the
//               founder of the Success System for ACT, EST, and SAT preparation.
//               <br /> OT LEARNING SYSTEM
//             </p>

//             <ul className="mt-3">
//               <li className="mt-3 flex items-center gap-2">
//                 <div className="bg-main-color text-white w-[30px] h-[30px] flex items-center justify-center rounded-full border">
...
function MoreAboutUs() {
  ...
  return (
    <section className="my-16 px-3 md:px-6">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            <div
              className="img-rs md:h-[450px] max-w-[562px] max-h-[702px] rounded-full overflow-hidden"
              style={{ boxShadow: "9px 8px 0px #1A2B4C" }}
            >
              <img src={omar} alt="OT" style={{ objectFit: "inherit" }} />
            </div>
          ...
          >
            ...
            <p className="mt-2">
              He was among the first educators in Egypt and the Arab world to
              specialize in ACT, EST, and SAT preparation for international
              school students. His proven teaching approach focuses on
              simplifying complex concepts, using practical problem-solving
              techniques, and creating real-life learning simulations. This
              unique method not only strengthens academic skills but also helps
              students gain confidence and achieve top results. Today, he is
              recognized as the founder of the OT Learning System, dedicated to
              student success in international exams.
            </p>
            ...
            <ul className="mt-3">
              <li className="mt-3 flex items-center gap-2">
                ...
                <p className="text-xl font-semibold">
                  Learn from a World-Class Instructor
                </p>
              </li>
              <li className="mt-3 flex items-center gap-2">
                <div className="bg-main-color text-white w-[30px] h-[30px] flex items-center justify-center rounded-full border">
              ...
              <li className="mt-3 flex items-center gap-2">
                ...
                <p className="text-xl font-semibold">Flexible Study Plans</p>
              </li>
            </ul>
