...
function StudentFeedBackBox({ feeStu }: any) {
  return (
    <div className="relative border-2 border-[#C9E4E9] rounded-[30px] p-5 mx-1">
      <div className="flex items-center gap-5">
        <div className="">
          <img src={feeStu.icon} alt="student 1" />
        </div>

        <div className="">
          <h2 className="font-bold text-xl">{feeStu.name}</h2>
          <h5 className="font-medium opacity-95">{feeStu.title}</h5>
        </div>
      </div>

      <p className="my-5">{feeStu.feedback}</p>
...
export default StudentFeedBackBox;
