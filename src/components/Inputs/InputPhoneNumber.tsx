...
//   // Destructuring countries from useCountries hook
//   const { countries } = useCountries();

//   // Defining country index as a number
//   const [country, setCountry] = useState<number>(230);

//   // Extracting data from selected country object
...
//           >
//             {/* Display country flag and calling code */}
//             <img
//               src={flags.svg}
//               alt={name}
...
//         >
//           {/* Map over countries to display options */}
//           {countries.map((country: Country, index: number) => (
//             <MenuItem
//               key={country.name}
//               className="flex items-center gap-2"
//               onClick={() => {
//                 setCountry(index); // Update selected country index
//                 getCodCountry(country.countryCallingCode); // Pass calling code to parent
//               }}
//               placeholder={undefined}
//               onPointerEnterCapture={undefined}
//               onPointerLeaveCapture={undefined}
...
//           }}
//           error={!!handlechange.errors.phone} // Boolean for error
//           onPointerEnterCapture={undefined}
//           onPointerLeaveCapture={undefined}
